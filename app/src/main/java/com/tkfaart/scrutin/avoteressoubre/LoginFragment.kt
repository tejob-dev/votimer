...
import com.tkfaart.scrutin.avoteressoubre.databinding.FragmentLoginBinding
...
class LoginFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val phoneEd = _binding?.edPhone
        val btnConnex = _binding?.btnConnex
...
//            }
        ...
        _binding?.btnRegister?.setOnClickListener(View.OnClickListener {
        ...
        btnConnex?.setOnClickListener(View.OnClickListener {
            val mobile = prf.getString("ag_tel")
            if(mobile.isEmpty()){
                var telephone = phoneEd?.text
                ...
                var telephone = checkPhoneNumber(phoneEd?.text?.trim().toString())
                var item = prf.getString("ag_tel")
                ...
                if(item.equals(telephone, ignoreCase = false)){
                    ...
                    SweetAlertDialog(requireContext(), SweetAlertDialog.WARNING_TYPE)
                        ...
                        .setContentText("Identifiant invalide!")
