...
import com.tkfaart.scrutin.avoteressoubre.databinding.FragmentManageWlPageBinding
 ...
 */
class ManageWlFragment : Fragment() {
    ...
    private var _binding: FragmentManageWlPageBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentManageWlPageBinding.inflate(inflater, container, false)
        return binding.root
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        _binding?.listVotant?.setOnClickListener {
            requireActivity().supportFragmentManager.beginTransaction()
                .setCustomAnimations(R.anim.slide_in_from_right, R.anim.slide_out_to_left,
                    R.anim.slide_in_from_left, R.anim.slide_out_to_right)
                .replace(R.id.fragment_container, ElectoratlistFragment())
                .commit()
        }
    }
