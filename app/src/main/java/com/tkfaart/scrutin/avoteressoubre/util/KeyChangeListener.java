 ...
 */
public class KeyChangeListener implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public static KeyChangeListener create(Activity activity){
        return new KeyChangeListener(activity);
    }

    public static KeyChangeListener create(Dialog dialog){
        return new KeyChangeListener(dialog);
    }

    private KeyChangeListener(Object contextObj) {
        if (contextObj == null) {
